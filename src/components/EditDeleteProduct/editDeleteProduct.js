...
const EditDeleteProduct = ({ products, setProducts, currentPage, setCurrentPage, limit, totalPages, requestPageProduct, requestedPages, user, errorSuccessMessage, setErrorSuccessMessage, setDeletedProducts, deletedProducts }) => {
