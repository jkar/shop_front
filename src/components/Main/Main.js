...
const Main = ({ logOut, products, setProducts, currentPage, setCurrentPage, limit, totalPages, requestPageProduct, requestedPages, user, deletedProducts, dropDownOptions, requestFilteredPageProduct, filter, setFilter, filteredProducts, setFilteredProducts, requestedFilterdPages, setRequestedFilteredPages, filterCurrentPage, setFilterCurrentPage, filterTotalPages, setFilterTotalPages, titleOption, setTitleOption }) => {
    ...
    return (
        <div className="mainPage">
            ...
            :
            <Products products={products} setProducts={setProducts} currentPage={currentPage} setCurrentPage={setCurrentPage} limit={limit} totalPages={totalPages} requestPageProduct={requestPageProduct} requestedPages={requestedPages} deletedProducts={deletedProducts} dropDownOptions={dropDownOptions} setFilter={setFilter} filter={filter} titleOption={titleOption} setTitleOption={setTitleOption} setFilterCurrentPage={setFilterCurrentPage} requestedFilterdPages={requestedFilterdPages} requestFilteredPageProduct={requestFilteredPageProduct} setFilteredProducts={setFilteredProducts} filteredProducts={filteredProducts} />
            }
            <Footer />
        </div>
    )
