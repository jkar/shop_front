  ...
  return (
    <div className="App">
        ...
        <Switch>
          ...
          <Route path="/formProduct" component={() => <FormProduct logOut={logOut} user={user} errorSuccessMessage={errorSuccessMessage} setErrorSuccessMessage={setErrorSuccessMessage} products={products} setProducts={setProducts} totalPages={totalPages} setTotalPages={setTotalPages} limit={limit} />} />
          <Route path="/editeDeleteProduct" component={() => <EditDeleteProduct logOut={logOut} products={products} setProducts={setProducts} currentPage={currentPage} setCurrentPage={setCurrentPage} limit={limit} totalPages={totalPages} requestPageProduct={requestPageProduct} requestedPages={requestedPages} user={user} errorSuccessMessage={errorSuccessMessage} setErrorSuccessMessage={setErrorSuccessMessage} setDeletedProducts={setDeletedProducts} deletedProducts={deletedProducts} />}></Route>
